...
TFile *f_ff_wgh = TFile::Open("/home/lisa/Desktop/T5gg_8_0_24_patch1/miniAOD/analysis/CorrectedJet/CheckVetoLEptons/MuonAndElectronVeto/CorrectJSON_MuonAndElectronVeto/R9Cut/DeltaEtaCut/BkgPrediction_BkgSubtr/QCD_Prediction.root");

TH1F* h_ee_MEt = (TH1F*)f_ff_wgh->Get("h_ee_ZZandTTJsubstract_w");

TH1F* h_gg_MEt = (TH1F*)f_ff_wgh->Get("h_real_MEt");
...
TLegend *leg1 = new TLegend(0.59, 0.80, 0.90, 0.90);
  ...
  leg1->AddEntry(h_ee_MEt, "     di-EM p_{T} Reweighted ee", "LP");
  leg1->AddEntry(h_ff_MEt, "     di-EM p_{T} Reweighted ff", "LP");
...
//Defineratio plot 2
 ...
 TH1F *h4 = (TH1F*)h_gg_MEt->Clone("h3");
