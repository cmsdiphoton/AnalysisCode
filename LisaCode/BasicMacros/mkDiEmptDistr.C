...
//TH1F* h_ff_MEt = (TH1F*)f_data->Get("ffDiEmPt");
...
TLegend *leg1 = new TLegend(0.52, 0.77, 0.83, 0.87);
  ...
  leg1->AddEntry(h_ff_MEt, " di-EM p_{T} distribution of control ff sample", "LP");
...
c->SaveAs("Plots/DiemPt_Distributions_ff_gg.pdf");
