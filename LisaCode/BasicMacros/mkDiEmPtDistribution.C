...
Int_t Nbins = 25;
float Xbins[26] = {0,3,6,9,12,15,18,22,26,29,32,36,40,45,50,60,70,85,100,115, 130, 150,175,200,300,1000};


TFile *f_data = TFile::Open("../newSkimm/analysis_NewMuonRecoVetoRemoveFinal_test.root");


TH1F *h_gg_MEt = new TH1F("h_gg_MEt","Missing Transverse Energy ",Nbins,Xbins);

TTree *gammatree = (TTree*)f_data->Get("ggtree");

gammatree->Draw("Dipho_Pt>>h_gg_MEt");


TH1F *h_ff_MEt = new TH1F("h_ff_MEt","Missing Transverse Energy ",Nbins,Xbins);

TTree *faketree = (TTree*)f_data->Get("fftree");

faketree->Draw("Dipho_Pt>>h_ff_MEt");
...
cout << "sum gg" << numf << endl;
		...
		h_gg_MEt->Scale(1/h_gg_MEt->Integral());
...
TLegend *leg1 = new TLegend(0.45, 0.7584, 0.899, 0.88);
  ...
  leg1->AddEntry(h_ff_MEt, " di-EM p_{T} Distribution of ff sample", "LP");
...
c->cd();          // Go back to the main canvas before defining pad2
 ...
 pad2->cd();       // pad2 becomes the current pad
  ...
  h_gg_MEt->GetYaxis()->SetTitleSize(18);
 ...
 h_gg_MEt->GetXaxis()->SetLabelFont(43);
...
h3->Sumw2();
 ...
 h3->GetXaxis()->SetTitle("di-EM p_{T} [GeV]");
