...
TFile *f_new = TFile::Open("../newSkimm/DiEMpt_Reweighting/ff_weighted/analysisFakeWithWeightsNJets2AllMetBin.root");
TH1F* h_ff_MEt_new = (TH1F*)f_new->Get("h_Fake_MEt_w");


TFile *f_old = TFile::Open("/Users/lisapaspalaki/Documents/T5gg_analysis/BasicCode/FebruaryStatus/newSkims_oldFakeDeFinition/ff_weighted/analysisFakeWithWeightsNJets2AllMetBin.root");
TH1F* h_ff_MEt = (TH1F*)f_old->Get("h_Fake_MEt_w");
...
TLegend *leg1 = new TLegend(0.589662, 0.719724 , 0.899789, 0.901694);
  ...
  leg1->SetHeader("Reweighted E_{T}^{miss} distributions");
