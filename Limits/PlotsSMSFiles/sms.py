...
class sms():
    ...
    def T5gg(self):
        ...
        # decay chain
        lsp_s = "#lower[-0.12]{#tilde{#chi}}#lower[0.2]{#scale[0.85]{^{0}}}#kern[-1.3]{#scale[0.85]{_{1}}}"
        self.label= "pp #rightarrow #tilde{g} #tilde{g}, #tilde{g} #rightarrow q #bar{q} #tilde{#chi}^{0}_{1}, #tilde{#chi}^{0}_{1} #rightarrow #gamma #tilde{G}";
        self.label2= "";
        # plot boundary. The top 1/4 of the y axis is taken by the legend
        self.Xmin = 1400.
        self.Xmax = 2025.
        self.Ymin = 0.
        self.Ymax = 2800.
        self.Zmin = 0.0011*1000
        self.Zmax = 0.0031*1000
        # produce sparticle
        self.sParticle = "m#kern[0.1]{_{#lower[-0.12]{#tilde{g}}}} [GeV]"
        # LSP  
        self.LSP = "m#kern[0.1]{_{"+lsp_s+"}} [GeV]"
    ...
    def T6gg(self):
        ...
        # decay chain                                                            
        lsp_s = "#lower[-0.12]{#tilde{#chi}}#lower[0.2]{#scale[0.85]{^{0}}}#kern[-1.3]{#scale[0.85]{_{1}}}"
        self.label= "pp #rightarrow #tilde{q} #bar{#tilde{q}}, #tilde{q} #rightarrow q #tilde{#chi}^{0}_{1}, #tilde{#chi}^{0}_{1} #rightarrow #gamma #tilde{G}";
        self.label2= "";
        # plot boundary. The top 1/4 of the y axis is taken by the legend 
        self.LineYmax = 800.                                                                                           
        self.Xmin = 1400.
...
#        self.Zmin = 0.0009
#        self.Zmax = 0.0031
        self.Zmin = 0.0010*1000.
        self.Zmax = 0.0015*1000.
        # produce sparticle                                                                                                                                                                                                                   
